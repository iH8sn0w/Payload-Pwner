...
Module modFile
    ...
    Public Sub ExtractIPSWipt2g()
        IPSW312 = Form2.find312.FileName
        Using zip1 As Ionic.Zip.ZipFile = Ionic.Zip.ZipFile.Read(IPSW312)
            zip1.ExtractAll(Form2.temppath & "\IPSW\")
            zip1.Dispose()

        End Using
        'Create_Directory(tempPath & "\ipsw\")
        'UnZip(ipsw, tempPath & "\ipsw\", 4096)
    End Sub
