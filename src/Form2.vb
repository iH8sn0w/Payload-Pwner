...
ByVal bRevert As Int32 _
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        MsgBox("Browse for iPod Touch 2G 3.1.2 ipsw.")
        find312.ShowDialog()
        ...
        Else
           ...
           Button1.Text = "Select a Save Location for your Payloads."
            ...
            Else
                ...
                cmdline = "xpwntool.exe " & Quote.Text & temppath & "\ipsw-pwner\Firmware\all_flash\all_flash.n72ap.production\iBoot.n72ap.RELEASE.img3" & Quote.Text & " " & Quote.Text & temppath & "\ipsw-pwner\iboot.d" & Quote.Text & " -iv 5e421f8ce8c811311bbbb8a734ec07ce -k 191b6846543d7026b6f0d5247f030588"
                ExecCmd(cmdline, True)
                cmdline = "bspatch.exe " & Quote.Text & temppath & "\ipsw-pwner\iboot.d" & Quote.Text & " " & Quote.Text & FolderBrowserDialog1.SelectedPath & "\iboot.payload" & Quote.Text & " " & Quote.Text & temppath & "\ipsw-pwner\iboot2g.patch"
                ExecCmd(cmdline, True)
