...
ByVal bRevert As Int32 _
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        MsgBox("Browse for iPod Touch 3 3.1.2 ipsw.")
        find312.ShowDialog()
        ...
        Else
            ...
            Else
                ...
                cmdline = "xpwntool.exe " & Quote.Text & temppath & "\ipsw-pwner\Firmware\all_flash\all_flash.n18ap.production\iBoot.n18ap.RELEASE.img3" & Quote.Text & " " & Quote.Text & temppath & "\ipsw-pwner\iboot.d" & Quote.Text & " -iv 6e7dc46c6a9cf573dda9af515c1b50ac -k eabfe2fc4bad7f97c090ed021e7fd80a7463251c4919a3c637d2a0c529b79d5a"
                ExecCmd(cmdline, True)
                cmdline = "bspatch.exe " & Quote.Text & temppath & "\ipsw-pwner\iboot.d" & Quote.Text & " " & Quote.Text & FolderBrowserDialog1.SelectedPath & "\iboot.payload" & Quote.Text & " " & Quote.Text & temppath & "\ipsw-pwner\iboot3g.patch"
                ExecCmd(cmdline, True)
